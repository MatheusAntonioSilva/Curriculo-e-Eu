      ...
      $UF = $_POST["cur_UF"];
        ...
        if ($status == 0){
            ...
            echo "Inscrição cadastrada com sucesso.<br>";
                header("Location: ../usuario/matheus/pdf.php");
        }
        }
        ?>