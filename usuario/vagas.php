...
// Check connection
                    ...
                    $sql = "SELECT vag_cat, vag_descri, vag_salario FROM vagas  ";
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result)) {
                            echo  "<div class='container'>".
                                  ...
                                  "<tbody>" .
                                  "<tr>". "<td>" . "<b>Tipo de vaga disponível</b>" . "</td>" . "<td>" . $row["vag_cat"] ."</td>". "</tr>".
                                  "<tr>". "<td>" . "<b>Descrição da vaga" . "</td>" . "<td>" . $row["vag_descri"] ."</td>". "</tr>".
                                  "<tr>". "<td>" . "<b>Salário" . "</td>" . "<td>" . $row["vag_salario"] ."</td>". "</tr> <br>";
                        }
                    } else {
