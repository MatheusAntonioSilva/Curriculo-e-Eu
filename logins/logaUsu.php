...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $email = $_POST['email'];
    $q_user = mysqli_query($conexao, "SELECT usu_email,usu_senha, usu_cod FROM cad_usuario WHERE usu_email='$email'");
...
//        
        ...
        if ($_POST['email'] == $dados['usu_email']) {
            if ($_POST['senha'] == $dados['usu_senha']) {
